...
(custom-set-variables
 ...
 '(package-selected-packages
   '(lsp-ui yasnippet lsp-mode treemacs which-key dap-mode lsp-ivy lsp-treemacs flycheck company php-mode yaml-mode web-mode twig-mode treemacs-icons-dired counsel)))
(custom-set-faces
